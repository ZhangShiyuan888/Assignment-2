...
namespace Assignment2.Models
{
    public class Product
    {
        ...
        //[Required(ErrorMessage = "The produce name cannot be blank")]
        //[StringLength(50, MinimumLength = 3, ErrorMessage = "Please enter a produce name between 3 and 50 characters in length")]
